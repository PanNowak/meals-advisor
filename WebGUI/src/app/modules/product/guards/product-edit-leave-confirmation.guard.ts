...
import {isCurrentProductIdenticalToLoaded} from 'app/modules/product/store';
...
export class ProductEditLeaveConfirmationGuard extends LeaveConfirmationGuard {
  ...
  protected noChangesSelector(): Selector<AppState, boolean> {
    return isCurrentProductIdenticalToLoaded;
  }
}
